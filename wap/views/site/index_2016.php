        ...
        <div style="">
            ...
            <?php foreach($model1 as $key=>$val){ ?>
                ...
                <li style="float: left;  list-style: none; margin-top: 20px;">
                    <div style=" height:152px; width:60%; margin-left: 16%; ">
                    ...
                    <div style="margin-top: 20px; width:330px;overflow:hidden;">
                        <a class="center-block" href="index.php?r=site/content&<?php echo 'id='.$val->id;?>" ><span><?php echo $val->event_name ?></span></a>
                    </div>
                </li>
            <?php } ?>
            </ul>
            ...
            <div style="">
                <ul style="height: 100%">
                    <?php foreach($model2 as $key=>$val){ ?>
                        ...
                        <li style="float: left;  list-style: none; margin-top: 20px;">
                            <div style=" height:152px; width:225px; margin-left: 45px; border: 1px seagreen solid">
