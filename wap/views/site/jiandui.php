...
<div class="row" style="width: 60%; margin: 0 auto;">
    ...
    <form role="form" method="post" action="http://www.51first.cn/index.php?r=site/jianle">
        <div class="form-group">
            ...
            <input id="team-name" class="form-control" type="text" name="gsname" />
        </div>
        <div class="form-group">
        ...
        <button id="btn-sub" class="btn btn-success" style="margin-top: 10px;" type="submit">创建战队</button>
    </form>
...
<script>
    document.getElementById("btn-sub").onclick=teamName;
    function teamName () {
        var val= document.getElementById("team-name").value;
        var txt = "组建战队成功！预祝您的“" + val + "”战队取得好成绩！";
        if (val) {
            alert(txt);
        }else{
            alert("请填写您的战队名称");
