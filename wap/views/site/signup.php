...
//        var ad = setInterval("doAlpha()",5);
    ...
    function get_mobile_code(){
        ...
        $.post('/mobile/sms.php', {mobile:jQuery.trim($('#signupform-phone').val()),send_code:<?php echo $_SESSION['send_code'];?>}, function(msg) {
    ...
    <div class="row" style="margin-bottom: 50px;">
        <div class="" style="margin: 0px auto; width: 500px;">
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                <input type="checkbox" name="checkbox" id="123" value="1" />
                <a href="index.php?r=mianze%2Fview&id=1" target="_blank" style="color: black;">免责条款</a>
                <div class="form-group">
                    <?= Html::submitButton('注册', ['class' => 'btn btn-primary', 'name' => 'signup-button','id' => '123456']) ?>
                    <a class="btn btn-primary" href="index.php?r=site/login">登录</a><!-- 小智 -->
...
<script>
    document.getElementById("123456").onclick=function(){
