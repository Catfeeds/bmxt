...
class SiteController extends Controller
{
     ...
     * @return string
     */
    public function actionGuanfang()
    {
        $data = relese::find()->where(['orgnize'=>'3']);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '6']);
        $model = $data->offset($pages->offset)->limit($pages->limit)->all();

        return $this->render('ognize',[
            'model' => $model,
            'pages' => $pages,
        ]);
    ...
    {
        $data = relese::find()->where(['orgnize'=>'2']);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '6']);
        $model = $data->offset($pages->offset)->limit($pages->limit)->all();
     ...
     * @return string
     */
    public function actionMinjian()
    {
        $data = relese::find()->where(['orgnize'=>'1']);
        $pages = new Pagination(['totalCount' =>$data->count(), 'pageSize' => '6']);
        $model = $data->offset($pages->offset)->limit($pages->limit)->all();
