...
class UsersSearch extends Users
{
    ...
    {
        return [
            [['user_id', 'birth_day', 'sex', 'phone', 'status', 'created_at', 'updated_at'], 'integer'],
            [['user_name', 'alias_name', 'real_name', 'address_province', 'address_city', 'email', 'password_hash', 'password_reset_token', 'auth_key'], 'safe'],
        ];
    }
