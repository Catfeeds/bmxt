            ...
            foreach($rows as $key => $val){
                switch($val['field_type']){
                    ...
                    case 4:
                        ...
                        $string_stem_radio .= '<label class="radio-inline"><input type="radio" name="'.$val['extends_name'].'" value="'.$val['field_number'].'"/>'.$val['field_content'].'</label>';
                        break;
                    //多选输入框
                    case 5:
                        $string_pre_box = '<div class="form-group"><label class="control-label">'.$val['field_name'].'：</label><div>';
                        $string_suf_box = '</div></div>';
                        $string_stem_box .= '<label class="checkbox-inline"><input type="checkbox" name="'.$val['extends_name'].'" value="'.$val['field_number'].'"/>'.$val['field_content'].'</label>';
                        break;
                    //下拉输入框
                    default:
                        ...
                        $string_stem_select .= ' <option value="'.$val['field_number'].'">'.$val['field_content'].'</option>';
                        break;
                }
            }
