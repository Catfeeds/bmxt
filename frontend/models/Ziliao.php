...
class Ziliao extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['username', 'auth_key', 'password_hash', 'email','xingming','dizhi', 'sex', 'created_at', 'updated_at', 'telphone', 'birthday','id_card'], 'required'],
            ...
            [['phone'], 'string', 'max' => 11],
            [['phone_code'], 'string', 'max' => 6],
            [['id_card'],'string','max'=>18,'min'=>18],
        ];
    }
