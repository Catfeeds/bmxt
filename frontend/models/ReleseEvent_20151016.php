...
class ReleseEvent extends \frontend\frontbase\BaseActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [[ 'orgnize_name','apply_money','contact_name','contact_phone','contact_emaill','event_type','event_name', 'apply_time_start', 'apply_time_end', 'contact_phone', 'orgnize', 'extend_id', 'user_id', 'is_end', 'wenzhang','jianjie'], 'required'],
            [['contact_phone','apply_money'], 'number'],
            [['contact_phone',],'match','pattern' => '/13[123569]{1}\d{8}|15[1235689]\d{8}|188\d{8}/'],
            [['apply_time_start','apply_time_end','event_name','orgnize_name','contact_name','event_name','wenzhang','jianjie'], 'string'],
