...
<div class="brief">
    ...
    <div class="left"><img src="<?=$basic_model['event_img']; ?>" width="480px" height="320px" /></div>
    <p class="right">
...
<div class="main">
    <ul class="nav_user" id="nav_user">
        ...
        <li class="nav3_user" style="background: #cccccc;">赛事结果</li>
...
<!--赛事报名-->
    <div id="sign_comp" style="display: none;">
        ...
        <input type="hidden" id="info-user_id" class="form-control" name="Info[user_id]" value="<?= Yii::$app->user->identity->id;?>">
        ...
        <input type="hidden" id="info-project" class="form-control" name="Info[bm_project]" value="<?php Yii::$app->request->get('id')?>">
...
<ul>
            ...
            foreach ($links as $link) {
                foreach($link as $name){
                    echo '<li style="float: left;list-style:none;padding: 10px;margin-bottom:100px; ">'.$name.'</li>';
                }
            }
