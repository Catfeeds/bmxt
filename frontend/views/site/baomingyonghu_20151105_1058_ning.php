            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function($messageProvider){
                            return $messageProvider->status == 1?"已接受" : Html::a('接受邀请','index.php?r=site/accept_invite&inviter='.$messageProvider->inviter.'&tid='.$messageProvider->tid.'&status=1&reply=1');
                        }
                    ],
                    [
                        'attribute' => 'reply',
