                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model){
                            $name=$model->name;
                            $url = "index.php?r=site/duiyou&name=$name";
                    ...
                    [
                        ...
                        'value' => function($model){
                            $id=$model->id;
                            $url = "index.php?r=site/serchname&name=''&tid=$id";
                    ...
                    [
                        ...
                        'value' => function($model){
                            $name=$model->name;
                            $url = "index.php?r=site/jiesan&name=$name";
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function($messageProvider){
                            return $messageProvider->status == 1?"已接受" : Html::a('接受邀请','index.php?r=site/accept-invite&inviter='.$messageProvider->inviter.'&beinviter='.Yii::$app->user->id.'&tid='.$messageProvider->tid.'&status=1&reply=1');
                        }
                    ],
                    [
                        'attribute' => 'reply',
