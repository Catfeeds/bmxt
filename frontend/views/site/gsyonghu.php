    ...
    <div class="limit_l" id="limit_l">
        ...
        <div class="favor_comp" id="favor_comp" >
            <table class="table table-bordered table-striped" id="elyInfo">
                <a class="but_bein btn btn-primary" href="index.php?r=gsemployee/index" style="margin: 10px;">增删员工列表</a>
                <a class="but_bein btn btn-primary" href="index.php?r=upload/upload" style="margin: 10px;">批量上传</a>
                <span class="text-info">请在批量上传前下载“员工格式表”</span>
                <a class="but_bein btn btn-danger pull-right" href="index.php?r=site/download" style="margin: 10px;">“员工格式表”下载</a>
                <thead>
                <tr>
                    <th>姓名</th>
                    <th>电话</th>
