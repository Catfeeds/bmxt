                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 ">
                        <select multiple class="form-control">
                            <option selected="selected">不限</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>                            <option>请选择类型</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="text-left">
                        ...
                        <label  class="radio-inline">
                            <input name="time" type="radio" value="2" />三天内
                        </label>
                        <label  class="radio-inline" style="margin-left: 85px;">
                            <input name="time" type="radio" value="3" />一周内
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="text-left">
                        ...
                        <label class="radio-inline">
                            <input name="place" type="radio" value="济南" />济南
                        </label>
                        <label  class="radio-inline">
                            <input name="place" type="radio" value="青岛" />青岛
                        </label>
                        <label  class="radio-inline">
                            <input name="place" type="radio" value="淄博" />淄博
                        </label>
                    </div>
                </div>
                <div class="form-group">
