...
<div class="brief">
    ...
    <div class="brief_2">
        <p style="font-weight:700;font-size:24px;margin:10px 0px 20px"><?=$basic_model['event_name'];?></p>
        <p>赛事地点：<?=$basic_model['place'];?></p>
        <p>赛事类型：<?=$basic_model['event_type'];?></p>
        <p>报名开始时间：<?=$basic_model['apply_time_start'];?></p>
        <p>报名结束时间：<?=$basic_model['apply_time_end'];?></p>
        <p>报名费：￥<?=$basic_model['apply_money']; ?></p>
        <p>主办方：<span style="color: red;">[<?=$basic_model['organize_type'];?>]</span></p>
