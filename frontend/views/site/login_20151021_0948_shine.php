...
$cssString="
    body{
        background:url(/frontend/web/css/images/beijing9.png) no-repeat;
        ...
        <div class="" style="width: 500px; margin: 0px auto;">
            <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                ...
                <div class="form-group">
                    ...
                    <a class="pull-right btn btn-primary" href="index.php?r=site/signup">注册账号</a><!--添加注册链接 shine_20151020-->
