...
<div class="brief">
    ...
    <div class="brief_2">
        ...
        <input type="button" name="submit" value="收藏" class="brief_btn2"onclick="javascript:location='index.php?r=site/shoucang&event_id=<?=$basic_model['id'];?>'">
    </p>
    </div>
...
<!--赛事报名-->
    ...
    <div id="sign_comp" style="display: none;">
        ...
        <?= $form->field($basic, 'bm_name')->textInput(['maxlength' => true,'style'=>'width:500px']) ?>
        <?= $form->field($basic, 'sex')->radioList(['1'=>'男','0'=> '女'])?>
        <?= $form->field($basic, 'phone')->textInput(['style'=>'width:500px']) ?>
        <input type="hidden" id="info-bm_time" class="form-control" name="Info[bm_time]" value="<?php echo time();?>">
        <?= $form->field($basic, 'email')->textInput(['maxlength' => true,'style'=>'width:500px']) ?>
        <?= $form->field($basic, 'id_number')->textInput(['maxlength' => true,'style'=>'width:500px']) ?>
