...
$sqls = "select id,event_name,event_img,jianjie,apply_time_start,apply_time_end from bm_relese_event WHERE is_top=1";
    ...
    <div class="hot">
        ...
        <div class="hot2">
            ...
            <p style="text-align: center;">
                <img src="../images/xiaobian.png" />王小编&nbsp;&nbsp;&nbsp;发布时间：2015/08/17
            </p>
        </div>
        <div class="hot3">
