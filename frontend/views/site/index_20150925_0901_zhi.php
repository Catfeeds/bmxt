            ...
            <?php foreach($model1 as $key=>$val){ ?>
                ...
                <li style="float: left;  list-style: none; margin-top: 20px;">
                    <div style=" height:152px; width:800px; margin-left: 25px; border: 1px seagreen solid">
                        <a href="index.php?r=site/content&<?php echo 'id='.$val->id;?>" ><img style="float: left;" width="223px;" height="150px;" src="uploads/20140826mzpygk.jpg"/></a>
                        <div class="float" style="margin-top: 20px;">
                        <p><?php echo $val->event_name ?></p>
                        <p>报名时间段：<?php echo $val->apply_time_start ?></p>
                        <p>比赛日期：<?php echo $val->place ?></p>
                        ...
                        <div class="float" style="float: left; margin-top: 20px; margin-left: 40px;">
                            <p>赛事类型：马拉松</p>
                            <p>报名费用：￥200</p>
                            <p>报名人数：<span style="color:red;">32</span></p>
                            <p>地点：山东 青岛 莱西市</p>

                        </div>
                        <div style="float: right; background: url('/frontend/web/uploads/lan.png') no-repeat; width: 49px;height: 48px; margin-top: 102px;">
