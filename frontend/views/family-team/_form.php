...
<input id="familyteam-family_team_id" class="form-control" name="FamilyTeam[family_team_id]" value="<?= $family_apply_id;?>" type="hidden">
...
if(count($rows) == 0){
                $this->context->redirect('index.php?r=site/yonghu');
                Yii::$app->session->setFlash('error', '请先添加新成员！');
    }else{
        $family_info ='';
