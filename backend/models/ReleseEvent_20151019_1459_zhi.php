...
class ReleseEvent extends \backend\backbase\BaseActiveRecord
{
    ...
    {
        return [
            [['addit', 'event_type', 'orgnize','is_extends','apply_money', 'user_id', 'is_end'], 'integer'],
            [[ 'orgnize_name','apply_money','contact_name','contact_phone','contact_emaill','event_type','event_name', 'apply_time_start', 'apply_time_end', 'contact_phone', 'orgnize', 'extend_id', 'user_id', 'is_end', 'wenzhang','jianjie','detailed','begin','place'], 'required'],
