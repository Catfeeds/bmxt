...
class ReleseEvent extends \backend\backbase\BaseActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [[ 'orgnize_name','apply_money','contact_name','contact_phone','event_type','event_name', 'apply_time_start', 'apply_time_end', 'contact_phone', 'orgnize', 'extend_id', 'user_id', 'is_end', 'wenzhang','jianjie','detailed','begin','place'], 'required'],
