...
class ReleseEventController extends BaseController
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['create','index','list','view','update','delete','un-addit','finish','totle','create-self','set-item','check','top'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $str1 = substr($str,-3);
                if($str1=='jpg'||$str1=='png'||$str1=='gif'){
                    ...
                    $a='uploads/';
                    $sql = "update bm_relese_event SET event_img='$a$randName' WHERE id='$model->id'";
    ...
    public function actionCheck()
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => ReleseEvent::find()->where(['addit'=>'1']),
